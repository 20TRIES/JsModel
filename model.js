...
Model.prototype._getAccessor = function _getAccessor (attribute_name)
{
    ...
    return this[method] instanceof Function
        ...
        : (function (name, value) { return this$1._.attributes[name]; }).bind(this, attribute_name);
};
...
Model.prototype._getMutator = function _getMutator (attribute_name)
{
    ...
    return this[method] instanceof Function
        ? this[method].bind(this)
        : (function (name, value) { this$1._.attributes[name] = value }).bind(this, attribute_name);
};
