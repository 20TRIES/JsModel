...
/**
 * An exception class that can be thrown when a value is out of range.
 */
var OutOfRangeException = (function (CollectionException) {
	function OutOfRangeException () {
		CollectionException.apply(this, arguments);
	}if ( CollectionException ) OutOfRangeException.__proto__ = CollectionException;
	OutOfRangeException.prototype = Object.create( CollectionException && CollectionException.prototype );
...
Collection.prototype.get = function get (id) {
    ...
    return this.filter(function (item) { return item[this$1.primary_key] == id; }).first();
};
 ...
 * @returns {Collection}
 */
Collection.prototype.slice = function slice (offset, size) {
    if (size <= 0) {
    ...
    var slice = new this.constructor([], this.primary_key);
    offset = offset >= 0 ? offset : size + offset;

    for (var i = 0, item = this.items[0]; i < this.count() && size > 0; item=this.items[++i]) {
        if (offset > 0) {
            --offset;
        } else {
            --size;
...
Collection.prototype.filter = function filter (callback) {
    ...
    var subset = new this.constructor([], this.primary_key);
    this.each(function (key, item, subset) {
        if(callback(this$1.items[key])) {
            subset.push(this$1.items[key]);
        }
    }, subset);
    return subset;
};
 ...
 */
Collection.prototype.each = function each (callback, data) {
        var this$1 = this;
        if ( data === void 0 ) data = {};

    for(var i=0; i < this.count(); ++i) {
        callback(i, clone(this$1.items[i]), data);
    }
};
...
Collection.prototype.pluck = function pluck (attribute, key) {
    ...
    var results = new this.constructor([], key);
    this.each(function (i, item, results) {
        var plucked = {};
        if(key != attribute) {
...
Collection.prototype.transform = function transform (callback) {
    var results = new Collection(null, this.primary_key);
 ...
 */
var JsModelException = function JsModelException(message) {
 ...
 * @return {String}
 */
JsModelException.prototype.toString = function toString () {
    return this._message;
};

var MissingQueryBuilderException = (function (JsModelException) {
	function MissingQueryBuilderException () {
		JsModelException.apply(this, arguments);
	}if ( JsModelException ) MissingQueryBuilderException.__proto__ = JsModelException;
	MissingQueryBuilderException.prototype = Object.create( JsModelException && JsModelException.prototype );
	MissingQueryBuilderException.prototype.constructor = MissingQueryBuilderException;

	

	return MissingQueryBuilderException;
}(JsModelException));

/**
 * A base Model collection class.
 */
var ModelCollection = (function (Collection) {
    function ModelCollection(items, model) 
    {
        Collection.call(this, items, model.getPrimaryKey());

        this._model = model;
    }

    if ( Collection ) ModelCollection.__proto__ = Collection;
    ModelCollection.prototype = Object.create( Collection && Collection.prototype );
    ModelCollection.prototype.constructor = ModelCollection;
     ...
     * @param {Builder} query
     */
    ModelCollection.prototype.setQuery = function setQuery (query)
    {
        this.query = query;
    };
     ...
     */
    ModelCollection.prototype.loadNextPage = function loadNextPage (success, error)
    {
...
var DuplicateVariableException = (function (JsModelException) {
	function DuplicateVariableException () {
		JsModelException.apply(this, arguments);
	}if ( JsModelException ) DuplicateVariableException.__proto__ = JsModelException;
	DuplicateVariableException.prototype = Object.create( JsModelException && JsModelException.prototype );
	DuplicateVariableException.prototype.constructor = DuplicateVariableException;

	

	return DuplicateVariableException;
}(JsModelException));

var UnknownVariableException = (function (JsModelException) {
	function UnknownVariableException () {
		JsModelException.apply(this, arguments);
	}if ( JsModelException ) UnknownVariableException.__proto__ = JsModelException;
	UnknownVariableException.prototype = Object.create( JsModelException && JsModelException.prototype );
	UnknownVariableException.prototype.constructor = UnknownVariableException;

	

	return UnknownVariableException;
}(JsModelException));
 ...
 * @returns {Array}
 */
HttpRequest.prototype.getHeaders = function getHeaders () {
 ...
 * @returns {String}
 */
HttpRequest.prototype.getDataType = function getDataType () {
 ...
 */
HttpRequest.prototype.setDataType = function setDataType (data_type) {
 ...
 * @returns {{}}
 */
HttpRequest.prototype.getData = function getData () {
    return this._data;
};
 ...
 * @param {{}} data
 */
HttpRequest.prototype.setData = function setData (data) {
    this._data = data;
};;
 ...
 * @param {String} method
 */
HttpRequest.prototype.setMethod = function setMethod (method) {
    this._method = method;
};;
 ...
 * @returns {string}
 */
HttpRequest.prototype.getUrl = function getUrl () {
    return this._url;
};
 ...
 * @param {String} url
 */
HttpRequest.prototype.setUrl = function setUrl (url) {
    this._url = url;
};;
 ...
 * @param {Function} callback
 */
HttpRequest.prototype.onSuccess = function onSuccess (callback) {
 ...
 * @param {Function} callback
 */
HttpRequest.prototype.onFailure = function onFailure (callback) {
 ...
 * @returns {*}
 */
HttpRequest.prototype.success = function success () {
        var args = [], len = arguments.length;
        while ( len-- ) args[ len ] = arguments[ len ];
 ...
 * @returns {*}
 */
HttpRequest.prototype.error = function error () {
        var args = [], len = arguments.length;
        while ( len-- ) args[ len ] = arguments[ len ];
...
var InvalidParameterException = (function (JsModelException) {
	function InvalidParameterException () {
		JsModelException.apply(this, arguments);
	}if ( JsModelException ) InvalidParameterException.__proto__ = JsModelException;
	InvalidParameterException.prototype = Object.create( JsModelException && JsModelException.prototype );
 ...
 */
var HttpDriver = function HttpDriver () {};

HttpDriver.execute = function execute (request) {
...
var jQuery = interopDefault(jquery);

/**
 * A Http Driver interface; should be extended by any Http Drivers.
 */
var JqueryHttpDriver = (function (HttpDriver) {
    function JqueryHttpDriver () {
        HttpDriver.apply(this, arguments);
    }

    if ( HttpDriver ) JqueryHttpDriver.__proto__ = HttpDriver;
    JqueryHttpDriver.prototype = Object.create( HttpDriver && HttpDriver.prototype );
    JqueryHttpDriver.prototype.constructor = JqueryHttpDriver;

    JqueryHttpDriver.execute = function execute (request) {
        HttpDriver.execute.call(this, request);
        jQuery.ajax({
            ...
            url: request.getUrl(),
            statusCode: {
                500: function (response) { return request.error(response, 500); },
                422: function (response) { return request.error(response, 422); },
                403: function (response) { return request.error(response, 403); },
                200: function (response) { return request.success(response, 200); },
            }
        });
    };
     ...
     * @private
     */
    JqueryHttpDriver._parseHeaders = function _parseHeaders (headers) {
        var parsed_headers = {};
    ...
    return JqueryHttpDriver;
}(HttpDriver));

/**
 * A builder class for building query strings for a Filterable API.
 */
var Builder = function Builder(model, driver)
{
    if ( driver === void 0 ) driver = JqueryHttpDriver;
 ...
 * @returns {*}
 */
Builder.prototype.getConstraintValue = function getConstraintValue (filter)
{
    var constraint = this._constraints.get(filter);
    return constraint != null
        ? (constraint.value instanceof Object ? clone$2(constraint.value) : constraint.value)
        : null;
};
 ...
 * @returns {Boolean}
 */
Builder.prototype.hasConstraint = function hasConstraint (filter)
{
 ...
 * @returns {Builder}
 */
Builder.prototype.orderBy = function orderBy ()
{
        var orderings = [], len = arguments.length;
        while ( len-- ) orderings[ len ] = arguments[ len ];
 ...
 * @returns {Array}
 */
Builder.prototype.orderingBy = function orderingBy ()
{
    return this.hasVariable('order') ? clone$2(this.getVariable('order')) : null;
};
 ...
 * @returns {int}
 */
Builder.prototype.getLimit = function getLimit ()
{
 ...
 * @returns {Builder}
 */
Builder.prototype.setLimit = function setLimit (value)
{
 ...
 * @returns {int}
 */
Builder.prototype.currentPage = function currentPage ()
{
 ...
 * @param {int} page
 */
Builder.prototype.setPage = function setPage (page)
{
 ...
 */
Builder.prototype.incrementPage = function incrementPage ()
{
 ...
 */
Builder.prototype.decrementPage = function decrementPage ()
{
    this.setPage(this.currentPage() - 1);
    return this;
};
 ...
 * @returns {Builder}
 */
Builder.prototype.append = function append (name, value)
{
 ...
 * @returns {boolean}
 */
Builder.prototype.hasVariable = function hasVariable (name)
{
 ...
 * @returns {*}
 */
Builder.prototype.getVariable = function getVariable (name, default_result)
{
        if ( default_result === void 0 ) default_result = null;
 ...
 * @returns {Builder}
 */
Builder.prototype.updateVariable = function updateVariable (name, value)
{
    if(this.hasVariable(name)) {
 ...
 * @returns {Builder}
 */
Builder.prototype.where = function where (filter, value)
{
    var constraint = this._constraints.get(filter);
    if(constraint == null) {
 ...
 * @returns {*}
 */
Builder.prototype.first = function first (success, error)
{
        if ( success === void 0 ) success = function () {};
        if ( error === void 0 ) error = function () {};

    return this.setLimit(1).get(function (results) {
 ...
 * @private
 */
Builder._newRequest = function _newRequest ()
{
 ...
 * @param {Function} error
 */
Builder.prototype.get = function get (success, error)
{
        var this$1 = this;
        if ( success === void 0 ) success = function () {};
        if ( error === void 0 ) error = function () {};

    var request = this.constructor._newRequest();
    request.setHeader('Accept', 'application/json');
    request.setDataType('json');
    request.setMethod('GET');
    request.setUrl(this._model.getUrl() + this.toQueryString());
    request.onSuccess(function (payload) {
        var models = this$1._encapsulateData(payload['data']);
        var collection = this$1._collectData(models);
...
Builder.prototype.toQueryString = function toQueryString ()
{
    ...
    this._appends.each(function (key, item) {
 ...
 * @returns {Array}
 */
Builder.prototype._encapsulateData = function _encapsulateData (items)
{
        var this$1 = this;
 ...
 * @private
 */
Builder.prototype._collectData = function _collectData (models)
{
    var collection = this._model.newCollection(models);
 ...
 * @returns {*}
 */
Builder.prototype.newModel = function newModel (data)
{
 ...
 * @param {function} [error=() => {}]
 */
Builder.prototype.update = function update (attributes, success, error)
{
        var this$1 = this;
        if ( success === void 0 ) success = function () {};
        if ( error === void 0 ) error  = function () {};
 ...
 * @param {function} [error=() => {}]
 */
Builder.prototype.insert = function insert (attributes, success, error)
{
        var this$1 = this;
        if ( success === void 0 ) success = function () {};
        if ( error === void 0 ) error  = function () {};
    ...
    request.onSuccess(function (payload) { return success(this$1._encapsulateData(payload['data'])[0]); });
    request.setData(attributes);
    request.onFailure(error);
    this._driver.execute(request);
};
...
var Moment = interopDefault(moment);

var _count = createCommonjsModule(function (module) {
...
var _count$1 = interopDefault(_count);
...
var _splitLeft = createCommonjsModule(function (module) {
...
var _splitLeft$1 = interopDefault(_splitLeft);


var require$$1 = Object.freeze({
  default: _splitLeft$1
});

var _splitRight = createCommonjsModule(function (module) {
...
var _splitRight$1 = interopDefault(_splitRight);


var require$$0 = Object.freeze({
  default: _splitRight$1
});
...
//******************************************************************************
  ...
  var __sp = S.prototype = {
    ...
    count: function(ss) {
      return interopDefault(require$$2)(this.s, ss)
    },
    ...
    splitLeft: function(sep, maxSplit, limit) {
      return interopDefault(require$$1)(this.s, sep, maxSplit, limit)
    },

    splitRight: function(sep, maxSplit, limit) {
      return interopDefault(require$$0)(this.s, sep, maxSplit, limit)
    },
...
var Str = interopDefault(string);

var InvalidAttributeException = (function (JsModelException) {
	function InvalidAttributeException () {
		JsModelException.apply(this, arguments);
	}if ( JsModelException ) InvalidAttributeException.__proto__ = JsModelException;
	InvalidAttributeException.prototype = Object.create( JsModelException && JsModelException.prototype );
...
var Model = function Model(attributes)
{
    ...
    this.getDates().forEach(function (value) {
        Object.defineProperty(this$1, value, {
            "configurable": true,
            "get": this$1._getAccessor(value),
            "set": this$1._getMutator(value)
        });
    }, this);
    ...
    for(var i in keys) {
        ...
        if((key.slice(0,3) === 'get' || key.slice(0,3) === 'set')
            && key.slice(-9) === 'Attribute' && this$1[key] instanceof Function) {
            var attribute = new Str(key.slice(3, -9)).underscore();
            if(!attribute.isEmpty()) {
                attribute = attribute.toString();
                Object.defineProperty(this$1, attribute, {
                    "configurable": true,
                    "get": this$1._getAccessor(attribute),
                    "set": this$1._getMutator(attribute)
                });
            }
        }
    }
 ...
 * @returns {Builder}
 */
Model.prototype.orderBy = function orderBy ()
{
        var orderings = [], len = arguments.length;
        while ( len-- ) orderings[ len ] = arguments[ len ];
 ...
 * @param {{}} attributes
 */
Model.prototype.fill = function fill (attributes)
{
        var this$1 = this;
 ...
 * @private
 */
Model.prototype._hydrate = function _hydrate (attributes)
{
        var this$1 = this;
    ...
    for(var key in attributes) {
        ...
        this$1._.attributes[key] = attributes[key];
        if (this$1.exists()) {
            this$1._.original[key] = attributes[key];
        }
    }

    // Define accessors and mutators for constructed attributes.
    for(var key$1 in this._.attributes) {
        Object.defineProperty(this$1, key$1, {
            "configurable": true,
            "get": this$1._getAccessor(key$1),
            "set": this$1._getMutator(key$1)
        });
    }
 ...
 * @private
 */
Model.prototype._getAccessor = function _getAccessor (attribute_name)
{
        var this$1 = this;

    var method = new Str(("get_" + attribute_name + "_attribute")).camelize().toString();
    var accessor = this[method];
    if(!(accessor instanceof Function)) {
        accessor = this.getDates().indexOf(attribute_name) === -1
            ? function (name, value) { return this$1._.attributes[name]; }
            : function (name, value) { return this$1._.attributes[name] === undefined ? null : new Moment(this$1._.attributes[name]); };
 ...
 * @private
 */
Model.prototype._getMutator = function _getMutator (attribute_name)
{
        var this$1 = this;

    var method = new Str(("set_" + attribute_name + "_attribute")).camelize().toString();
    var mutator = this[method];
    if(!(mutator instanceof Function)) {
        mutator = this.getDates().indexOf(attribute_name) === -1
            ? function (name, value) { this$1._.attributes[name] = value }
            : function (name, value) { this$1._.attributes[name] = value instanceof Moment ? value.format() : value };
...
Model.prototype.getAttributes = function getAttributes ()
{
    ...
    for(var key in this._.attributes) {
        if(this$1._.attributes.hasOwnProperty(key)) {
            attributes[key] = this$1[key];
        }
    }
    // Get all dynamically defined attributes.
    for(var key$1 in this) {
        if(key$1 != '_' && this$1.hasOwnProperty(key$1)) {
            attributes[key$1] = this$1[key$1];
        }
    }
    return attributes;
};
 ...
 * @returns {*}
     */
Model.prototype.getAttribute = function getAttribute (name)
{
 ...
 * @returns {Array}
 */
Model.prototype.getDates = function getDates ()
{
 ...
 * @returns {boolean}
 */
Model.prototype.isSyncing = function isSyncing ()
{
 ...
 * @returns {string}
 */
Model.prototype.getUrl = function getUrl ()
{
    return this._.url;
};
 ...
 */
Model.prototype.exists = function exists ()
    {
 ...
 * @returns {string|int}
 */
Model.prototype.getPrimaryKey = function getPrimaryKey ()
{
 ...
 * @returns {Builder}
 */
Model.prototype.where = function where (attribute, value) {
 ...
 * @returns {ModelCollection}
 */
Model.prototype.find = function find (id, success, error) {
 ...
 * @returns {*}
 */
Model.prototype.newCollection = function newCollection (data) {
 ...
 * @returns Object
 */
Model.prototype.dirty = function dirty () {
        var this$1 = this;

    var dirty = {};
    for(var key in this.getAttributes()) {
        var value = this$1.getAttribute(key);
        if(value != this$1.getOriginal(key)) {
            if(value != null && typeof value === 'object') {
                dirty[key] = this$1.getAttribute(key);
            } else {
                dirty[key] = value;
            }
        }
 ...
 */
Model.prototype.save = function save (success, error) {
    var instance = this;
...
Model.prototype.reset = function reset ()
{
    ...
    for (var key in this._.attributes) {
        if (this$1._.attributes.hasOwnProperty(key)) {
            if(this$1.hasOriginal(key)) {
                this$1._.attributes[key] = this$1.getOriginal(key);
            } else {
                delete this$1._.attributes[key];
            }
        }
    }
 ...
 * @param error
 */
Model.prototype.deleteModel = function deleteModel (success, error)
{
    var instance = this;
 ...
 * @returns {Model}
 */
Model.prototype.clone = function clone$1 () {
    var cloned_model = new this.constructor(clone$2(this.getAttributes()));
    cloned_model._.original = clone$2(this._.original);
...
exports.InvalidAttributeException = InvalidAttributeException;
exports.HttpDriver = HttpDriver;
exports.HttpRequest = HttpRequest;
exports.DuplicateVariableException = DuplicateVariableException;
exports.UnknownVariableException = UnknownVariableException;
exports.JqueryHttpDriver = JqueryHttpDriver;